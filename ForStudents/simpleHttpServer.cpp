...
#define		GRAPH_PROG_FILEPATH	"/bin/java"
...
/*execl)
        ...
        Dhttps.proxyHost=proxy.is.depaul.edu",
        "-Dhttps.proxyPort=312",
        "-cp","/usr/share/java/jsoup-1.12.1.jar",
        "graphServer",
        EXOPLANET_DATA_URL, NULL);
				...
				fromGraphFd_(ERROR_FILE_DESCRIPTOR)
{
  ...
  if  (graphPid_ == 0)
  {
    ...
    //execl(GRAPH_PROG_FILEPATH,GRAPH_PROG_FILEPATH,EXOPLANET_DATA_URL,NULL);
    execl(GRAPH_PROG_FILEPATH, GRAPH_PROG_FILEPATH,
        "-Dhttps.proxyHost=proxy.is.depaul.edu",
        "-Dhttps.proxyPort=312",
        "-cp",
        "/usr/share/java/gson-2.8.6.jar",
        "GnuPlotMaker",
        EXOPLANET_DATA_URL, NULL);
